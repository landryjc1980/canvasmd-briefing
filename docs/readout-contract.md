...
| Attention-ranked morning leads (16 September decision) | All oncology fills up to five admitted leads in global rank order after excluding prior morning leads, with no per-specialty cap. Missing abstracts do not demote an otherwise eligible paper. A previous Also Relevant placement may earn its first lead if current attention still qualifies. Missing, boilerplate or visibly clipped source descriptions are withheld in the web reader while the title, journal, source link and scoped clinician evidence remain visible. Audio still requires complete original evidence and retains its omission checks. Preprints retain their non-lead rule. Ordinary publisher preparation cannot rebuild a saved edition; an explicit service-authorized repair is required. |
