...
| Source-ready morning leads | Retain the two-per-specialty paper cap. Missing, boilerplate or visibly clipped source text cannot fill a lead position; those otherwise eligible papers remain in Also Relevant. Fewer than five leads is valid. An already saved edition is not rebuilt by publisher preparation; inspection uses its non-mutating dry run. |
