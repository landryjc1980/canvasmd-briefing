...
function harness({ hour = 6, canonicalError = null, mismatch = false } = {}) {
  const calls = [];
  const job = {
  ...
  const mocks = {
    ...
    "@/lib/readoutWindowServer": { READOUT_WINDOW_CACHE_TAG: "tag", warmReadoutWindow: async () => ({ stale: false, editionDate: mismatch ? "2026-09-10" : "2026-09-11", selectionVersion: "readout-v1-a" }) },
